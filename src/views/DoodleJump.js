...
export default function DoodleJump() {
    ...
    // return (
    //     <div className="grid doodle bg-yellow-300 justify-items-center content-around">
    //         <button className="bg-red-400 h-6 w-24">New Game</button>
    //     </div>
    // )

    // let {isDoodlePresent} = this.state;
    // if (isDoodlePresent) {
        return (
            <div className="grid doodle bg-yellow-400">
                <div className="doodler bg-red-500">
                </div>
            </div>
        )
    // }else{
